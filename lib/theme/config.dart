...
class Colors {
  final Color _mainColor = const Color(0xFFF0F0F0);
  final Color _secondColor = const Color(0xFF181818);
  final Color _accentColor = const Color(0xFF2F2F2F);
  final Color _textColor = const Color(0xFFF0F0F0);
  ...
  LinearGradient waves = const LinearGradient(
    colors: [Color(0xff0F619F),Color(0xa50f619f)],
  ...
  LinearGradient mildSeaRev = const LinearGradient(
    colors: [Color(0xFF26A6B5), const Color(0xFF96EFA6)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient purplin = const LinearGradient(
    colors: [const Color(0xFFA044FF), const Color(0xFF6A3093)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  ...
  LinearGradient aqua = const LinearGradient(
    colors: [Color(0xFF5B86E5), const Color(0xFF36D1DC)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );

  LinearGradient alive = const LinearGradient(
    colors: [const Color(0xFFBD3F32), const Color(0xFFCB356B)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
